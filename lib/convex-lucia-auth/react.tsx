...
import { FormEvent, ReactNode, createContext, useCallback, useContext, useState } from 'react'
...
export function SignUpSignIn({
	...
	return (
		<form onSubmit={onSubmit}>
			...
			<input className={inputClassName} name='email' id='email' autoComplete='username' />
